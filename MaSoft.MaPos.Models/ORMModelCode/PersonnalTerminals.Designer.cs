...
namespace MaSoft.MaPos.Models.MaPos
{
    ...
    public partial class PersonnalTerminals : XPLiteObject
    {
        int fRowID;
        [Key(true)]
        public int RowID
        ...
        int fPersonnalID;
        [Indexed(@"TerminalID", Name = @"Idx_IDs")]
        public int PersonnalID
        {
            get { return fPersonnalID; }
            set { SetPropertyValue<int>(nameof(PersonnalID), ref fPersonnalID, value); }
        }
        int fTerminalID;
        public int TerminalID
        {
            get { return fTerminalID; }
            set { SetPropertyValue<int>(nameof(TerminalID), ref fTerminalID, value); }
        }
        string fDescription;
        [Size(250)]
