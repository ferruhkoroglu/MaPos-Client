...
namespace MaSoft.MaPos.Models.MaPos
{
    ...
    public partial class MillUnits : XPLiteObject
    {
        int fRowID;
        [Key(true)]
        public int RowID
        ...
        string fMillUnitName;
        [Indexed(Name = @"Idx_MillName")]
        [Size(50)]
        public string MillUnitName
        {
            get { return fMillUnitName; }
            set { SetPropertyValue<string>(nameof(MillUnitName), ref fMillUnitName, value); }
        }
        string fDescription;
        [Size(250)]
