...
namespace MaSoft.MaPos.Models.MaPos
{
    ...
    public partial class CashBoxInputs : XPLiteObject
    {
        int fRowID;
        [Key(true)]
        public int RowID
        ...
        {
            get { return fInputAmount; }
            set { SetPropertyValue<float>(nameof(InputAmount), ref fInputAmount, value); }
        }
        string fCurrency;
        [Size(10)]
        ...
        public int InputType
        {
            ...
            set { SetPropertyValue<int>(nameof(InputType), ref fInputType, value); }
        }
        string fDescription;
        [Size(250)]
