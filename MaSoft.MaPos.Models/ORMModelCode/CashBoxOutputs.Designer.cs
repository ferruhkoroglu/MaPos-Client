...
namespace MaSoft.MaPos.Models.MaPos
{
    ...
    public partial class CashBoxOutputs : XPLiteObject
    {
        int fRowID;
        [Key(true)]
        public int RowID
        ...
        {
            get { return fVoucherNo; }
            set { SetPropertyValue<string>(nameof(VoucherNo), ref fVoucherNo, value); }
        }
        int fCashBoxID;
        [Indexed(@"Currency", Name = @"NI_CashBoxInputs")]
        ...
        {
            get { return fOutputAmount; }
            set { SetPropertyValue<float>(nameof(OutputAmount), ref fOutputAmount, value); }
        }
        string fCurrency;
        [Size(10)]
        ...
        {
            get { return fOutputType; }
            set { SetPropertyValue<int>(nameof(OutputType), ref fOutputType, value); }
        }
        string fDescription;
        [Size(250)]
