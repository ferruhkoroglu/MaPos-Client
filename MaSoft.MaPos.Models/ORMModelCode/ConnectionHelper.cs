...
namespace MaSoft.MaPos.Models.MaPos
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(Banks),
            typeof(CashBoxes),
            typeof(CashBoxInputs),
            typeof(CashBoxOutputs),
            typeof(CashBoxSummaryInfo),
            typeof(CollectionAccount),
            typeof(CustomerGroups),
            typeof(Customers),
            typeof(Departments),
            typeof(MillUnits),
            typeof(Personnal),
            typeof(PersonnalTerminals),
            typeof(Portion),
            typeof(Printers),
            typeof(PrintTask),
            typeof(ProductGroup),
            typeof(ProductPrices),
            typeof(Products),
        ...
        public const string ConnectionStringName = "MaPosConnection";
