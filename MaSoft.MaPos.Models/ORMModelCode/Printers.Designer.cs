...
namespace MaSoft.MaPos.Models.MaPos
{
    ...
    public partial class Printers : XPLiteObject
    {
        int fRowID;
        [Key(true)]
        public int RowID
        ...
        string fWindowsPrinterName;
        [Size(250)]
        public string WindowsPrinterName
        {
            get { return fWindowsPrinterName; }
            set { SetPropertyValue<string>(nameof(WindowsPrinterName), ref fWindowsPrinterName, value); }
        }
        string fDescription;
        [Size(250)]
